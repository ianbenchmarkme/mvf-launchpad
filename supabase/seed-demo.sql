...
INSERT INTO apps (name, problem_statement, layer, category, target_users, potential_roi, needs_business_data, handles_pii, uses_api_keys, api_key_services, replaces_third_party, replaced_tool_name, replaced_tool_cost, tier, status, created_by)
VALUES
  (
    'Delphi',
