    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-4 flex-1">
          {/* App icon or letter placeholder — 72×72 */}
          {app.icon_url ? (
            <img
              src={app.icon_url}
              alt=""
            ...
            <div className={`flex h-[60px] w-[60px] shrink-0 items-center justify-center rounded-[8px] text-[22px] font-semibold ${placeholderBg[app.tier]}`}>
          ...
          <div className="flex flex-col min-w-0 flex-1">
            ...
            <p className="mt-2 text-[12px] leading-[1.6] text-muted-foreground line-clamp-3">
              {app.problem_statement}
            </p>
          </div>
        </div>
        <div className="mt-3 pt-3 border-t border-border flex items-center gap-2 text-[11px] text-muted-foreground/80 shrink-0">
