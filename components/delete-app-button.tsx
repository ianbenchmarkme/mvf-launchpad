  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 rounded border border-red-200 px-3 py-2 text-sm text-red-600 hover:bg-red-50 active:scale-[0.98] transition-all duration-150"
      >
      ...
      {showMessage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded bg-card p-6 shadow-xl space-y-4">
            ...
            <div className="flex justify-end">
              <button
                type="button"
                onClick={() => setShowMessage(false)}
                className="rounded bg-mvf-dark-blue px-4 py-2 text-sm font-medium text-white hover:bg-mvf-dark-blue/90 active:scale-[0.98] transition-all duration-150"
              >
                Understood
              </button>
            </div>
